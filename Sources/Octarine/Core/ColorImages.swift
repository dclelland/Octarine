...
public struct ColorMatrix<Scalar> where Scalar: Real {
    
    public typealias Matrix = Plinth.Matrix<Scalar>
    public typealias Pixel = (red: Scalar, green: Scalar, blue: Scalar)
...
extension ColorMatrix {
    ...
    public static var empty: ColorMatrix {
...
extension ColorMatrix {
    ...
    public enum Malformation: CustomStringConvertible {
        ...
        public enum Channel {
            ...
            case red(Matrix.Malformation)
            case green(Matrix.Malformation)
            case blue(Matrix.Malformation)
            
        }
        
        case parts(_ red: Matrix.Malformation, _ imaginary: Matrix.Malformation)
        case redPart(_ real: Matrix.Malformation)
        case greenPart(_ imaginary: Matrix.Malformation)
        case bluePart(_ imaginary: Matrix.Malformation)
        case shapeMismatch(_ red: Shape, _ green: Shape, _ blue: Shape)
